...
stacked_raster_values_and_garden_CT_all_seasons_no_nas <- readRDS( here::here("output", "data-proc", "dryad", paste0("Louvrier_2021_JAE_UrbanMesocarnivores_Covariates_cameras_Dryad2021_10_29.RDS")))
