...
stacked_raster_values_and_garden_CT_all_seasons_no_nas <- readRDS( here::here("data", "detections_all_species", paste0("Louvrier_2021_JAE_UrbanMesocarnivores_Covariates_cameras_Dryad2021_10_29.RDS")))

#already formated and filtered data with a delta of 30 mins
CT_act_date_formated <- readRDS(here::here("output", "detections_all_species","Louvrier_2021_JAE_UrbanMesocarnivores_Camera_detections_Dryad2021_01_11.RDS"))
